...
Covid-19 has been a global health crisis since late 2019, and this is a data set from the data.gov website. Here we would like to focus on covid-19 cases and deaths in the five regions in New York City. We will address several questions and give a conclusion of what causes the increase or decreaase in cases and deaths.
...
DeathsTotal <- Final2 %>% group_by (Month, Year) %>% summarize(TotalDeaths = sum(DEATH_COUNT),.groups = 'drop')  %>% 
  group_by(Year) %>% 
